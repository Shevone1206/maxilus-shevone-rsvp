...
*/
const TRACKS = [
  { title: "♪ 六边形", src: "https://raw.githubusercontent.com/Shevone1206/maxilus-shevone-rsvp/main/wedding-rsvp/audio/track-1.mp3" },
  { title: "♪ 小冒旅", src: "https://raw.githubusercontent.com/Shevone1206/maxilus-shevone-rsvp/main/wedding-rsvp/audio/track-2.mp3" }
];
...
const translations = {
  zh: {
    ...
    detailsEyebrow:"给你的一封小邀请",detailsTitle:"请记下这个日子",whenLabel:"日期",whenCopy:"星期六<br /><strong>2026年9月19日</strong>",scheduleLabel:"当天安排",scheduleCopy:"<strong>5:30 PM</strong> · 敬茶仪式<br /><strong>7:00 PM</strong> · 婚宴庆祝",whereLabel:"地点",whereCopy:"<strong>金阳迎宾楼</strong><br /><span class=\"chinese-name\">Golden Sun Restaurant</span><br />Kuchai Lama",teaNote:"<span>家人及亲戚</span> 敬请于 <strong>5:30 PM</strong> 前抵达，参与敬茶仪式。",calendarGoogle:"添加到 Google 日历",calendarApple:"添加到日历 (Apple/Outlook)",
...
if (TRACKS.length) {
  ...
  musicAudio.addEventListener("ended", () => loadTrack(currentTrack + 1, true));
} else {
...
/* add to calendar (Apple/Outlook): generate an .ics file on the fly */
const icsButton = document.querySelector("#ics-calendar-btn");
icsButton.addEventListener("click", (event) => {
  event.preventDefault();
  const ics = [
    "BEGIN:VCALENDAR",
    "VERSION:2.0",
    "BEGIN:VEVENT",
    "UID:maxilus-shevone-wedding-20260919@wedding-rsvp",
    "DTSTAMP:20260808T000000Z",
    "DTSTART:20260919T093000Z",
    "DTEND:20260919T150000Z",
    "SUMMARY:Maxilus & Shevone's Wedding",
    "LOCATION:Golden Sun Restaurant, Kuchai Lama, Kuala Lumpur",
    "DESCRIPTION:Tea ceremony at 5:30 PM, wedding celebration at 7:00 PM. Can't wait to celebrate with you!",
    "END:VEVENT",
    "END:VCALENDAR"
  ].join("\r\n");
  ...
  a.href = url;
  a.download = "maxilus-shevone-wedding.ics";
